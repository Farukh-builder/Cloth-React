...
export function Settings() {
  ...
  const [memberUpdateInput, setMemberUpdateInput] = 
    useState<MemberUpdateInput>({
      ...
      memberAdrress: authMember?.memberAdrress,
  ...
  /* HANDLERS */ 
    ...
    memberUpdateInput.memberAdrress = e.target.value;
    setMemberUpdateInput({ ...memberUpdateInput })
  };
  ...
  const handleSubmitButton = async () => {
    try {
      ...
      if (memberUpdateInput.memberNick === "" 
        ...
        || memberUpdateInput.memberAdrress === ""
      ...
      <Box className={"input-frame"}>
        ...
        <div className={"short-input"}>
          ...
          <input
            ...
            type="text"
            placeholder={authMember?.memberAdrress 
              ? authMember.memberAdrress 
              : "no address" }
            value={memberUpdateInput.memberAdrress}
            name="memberAddress"
